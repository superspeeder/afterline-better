...
public abstract class Message {
    ...
    public static void register(Class<? extends Message> msgClass) {
        ...
        if (annotation == null) {
            MessageSystem.LOGGER.error("Cannot register a message class without an explicitly provided id through Message#register or the @MessageID annotation");
        } else {
    ...
    public static Message create(int id, long size, ByteBuf data) {
        if (!messageRegistry.containsKey(id)) {
            MessageSystem.LOGGER.error("Cannot create a message with invalid id {}", id);
            return null;
        }
        ...
        try {
            ...
            MessageSystem.LOGGER.catching(e);
            MessageSystem.LOGGER.error("Failed to create a message with the given id {}", id);
            return null;
        }
    }
